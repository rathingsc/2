...
public class GrammarDiagnosisFragment extends Fragment {
    ...
    private void render(){
        ...
        summary.setText(total==0?"还没有足够的语法答题数据。做几组句型训练或自由对话后，这里会自动找出最容易出错的语法点。":"已分析 "+total+" 次语法作答 · 总正确率 "+accuracy+"% · 优先显示最值得补的弱点");
